...
var serverRoutes = {
    discounts: {
        getActiveDiscounts: function getActiveDiscounts() {
            return {
                method: 'get',
                url: '/api/get-active-discounts'
            };
        },
        getInActiveDiscounts: function getInActiveDiscounts() {
            return {
                method: 'get',
    ...
    shoppingCart: {
        getAllShoppingCartInfo: function getAllShoppingCartInfo() {
            return {
                method: 'get',
                url: '/api/get-all-shopping-cart-info'
            };
        },
        getTotalPriceWithoutPrice: function getTotalPriceWithoutPrice() {
            return {
                method: 'get',
...
var photosCarousel = {
    ...
    rendering: {
        renderLabel: function renderLabel(label) {
            var productsPhotosCarouselLabelElement = document.getElementById('products-photos-carousel-label');

            productsPhotosCarouselLabelElement.innerHTML = label;
        },
        renderImages: function renderImages(images) {
            var productsPhotosListElement = document.getElementById('products-photos-list');
...
var discounts = {
    ...
    rendering: {
        renderActiveDiscounts: function renderActiveDiscounts(discountsList) {
        ...
        renderInActiveDiscounts: function renderInActiveDiscounts(discountsList) {
            for (var i = 0; i < discountsList.length; i++) {
...
var shoppingCart = {
    shoppingCartList: [],
    actions: {
        setShoppingCartList: function setShoppingCartList(list) {
            shoppingCart.shoppingCartList = list;
        },
        getProductPriceSum: function getProductPriceSum(productId) {
            for (var item in shoppingCart.shoppingCartList) {
        ...
        has: function has(id) {
            ...
            return new Promise(function (resolve) {
                _this.list().then(function (shoppingCart) {
                    shoppingCart = shoppingCart.data;

                    for (var i = 0; i < shoppingCart.length; i++) {
                        if (shoppingCart[i].id === id) resolve(true);
                    }resolve(false);
                });
            });
        },
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return axios(serverRoutes.shoppingCart.add({
                                    id: data.id,
                                    title: data.title,
    ...
    rendering: {
        setProductsPriceSum: function setProductsPriceSum(shoppingCart) {
            var _iteratorNormalCompletion = true;
            var _didIteratorError = false;
            var _iteratorError = undefined;

            try {
                for (var _iterator = shoppingCart[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        showBottomInfoBlock: function showBottomInfoBlock() {
            $('[data-shopping-cart-info]').css('display', 'block');
        },
        hideBottomInfoBlock: function hideBottomInfoBlock() {
        ...
        setTotalPrice: function setTotalPrice(price) {
            ...
            } else this.hideBottomInfoBlock();
        },
        setTotalPriceWithoutPrice: function setTotalPriceWithoutPrice(priceWithoutDiscount, price) {
            var priceWithoutDiscountElement = $('#price-without-discounts');
...
var amountOfQueuedShoppingCartProducts = 0;

$(document).ready(function () {

    shoppingCart.actions.getAllShoppingCartInfo().then(function (res) {
    ...
    shoppingCart.actions.list().then(function (response) {
...
$('input[data-product]').on('input', function (event) {
    ...
    var minAmount = event.target.hasAttribute('data-min-number') ? event.target.getAttribute('data-min-number') : 0;
    ...
    if (amount >= minAmount) {
        ...
        loadingBar.checkQueue();
        shoppingCart.actions.add(data).then(function (res) {
            amountOfQueuedShoppingCartProducts--;
            loadingBar.checkQueue();
            shoppingCart.rendering.update(res);
...
$('*[product-photos-carousel-trigger]').on('click', function () {
    jQuery.noConflict();
    var productId = Number($(this).attr('product-photos-carousel-trigger'));

    photosCarousel.actions.getImages(productId).then(function (res) {
...
$('*[data-remove-product-id]').on('click', function () {
    var productId = Number($(this).attr('data-remove-product-id'));

    shoppingCart.actions.delete(productId).then(function (res) {
